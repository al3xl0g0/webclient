		...
		function updateCoupon() {
			...
			console.log(this.newValue);
			$.getJSON(`http://localhost:8080/finallProjectWeb/rest/coupon/updateCoupon?couponID=${couponID}&filedToChange=${filedToChange}&newValue=${this.newValue}`,
					function(data) {
		...
		function shutDown() {
			console.log('this is js system shut down')
			
			$.get("http://localhost:8080/finallProjectWeb/rest/admin/shutDown");
